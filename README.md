...
- **KAI Chat v3 (latest):** https://junaid-kameleoon.github.io/Claude/Kai%20v3/ — adds `@mentions` (reference experiments, personalizations, segments & triggers inline) on top of v2.2
- **KAI Chat v2.2:** https://junaid-kameleoon.github.io/Claude/Kai%20v2.2/ — experiment copilot, "Under the hood" live event feed, interactive Architecture diagram
